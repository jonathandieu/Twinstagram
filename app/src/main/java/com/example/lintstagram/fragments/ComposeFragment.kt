...
class ComposeFragment : Fragment() {
    ...
    lateinit var ivPreview: ImageView // Without this, we will have never initialized it, until later.
...
//                Log.e(TAG, "Couldn't submit properly")
        ...
        view.findViewById<Button>(R.id.btnCaptureImage).setOnClickListener {
